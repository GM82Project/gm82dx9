...
#define buffer_get_surface
    ...
    if (__gm82dx9_surface_to_buffer(buffer_get_address(__buf),__surf,surface_get_width(__surf),surface_get_height(__surf))==-1) show_error("Error in __gm82dx9_surface_to_buffer.",0)
    return 1
